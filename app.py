...
def transcribe_audio_openai(file_path: str, language_code: str, filename_hint: str = "audio") -> str:
    ...
    If the file exceeds the safe limit, it is split into segments with a safety margin to avoid the 25 MB limit,
    each segment is transcribed, and the transcripts are joined.
    """
    try:
        ...
        if file_size > safe_limit:
            ...
            # Compute segment duration, then reduce by an additional 2% margin
