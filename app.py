...
def transcribe_audio_data(audio_data: bytes, language_code: str, filename_hint: str = "audio") -> str:
    try:
        ...
        # Note: The Deepgram API call is synchronous.
            ...
            with st.spinner("Step 2/2: Transcribing WAV audio using Deepgram (detecting language)..."):
                try:
                    ...
                    if not audio_data:
                        ...
                        # Call the synchronous transcription function directly.
                        transcript_text = transcribe_audio_data(audio_data, lang_code_to_process, filename_hint)
                except Exception as e:
